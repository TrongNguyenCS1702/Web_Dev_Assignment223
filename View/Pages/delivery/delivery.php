    ...
    <div class="main-prod">
      ...
      <div class="sub-main-prod">
        ...
        <div class="item-cat-product">
                    ...
                    <ul>
                      <li class="checked">
                        <a href="#" class="color-picker">
                            <img src="/View/Pages/delivery/img/004.png" class="lazy">
                        </a>
                      </li>
                      <li>
                        <a href="#" class="color-picker" >
                            <img src="/View/Pages/delivery/img/014.png"  class="lazy">
                        </a>
                      </li>
                      <li>
                          <a href="#" class="color-picker">
                              <img src="/View/Pages/delivery/img/017.png" class="lazy">
                          </a>
                      </li>
                    </ul>
                  </div>
          ...
          </div> <div class="item-cat-product">
            <div class="product">
                <div class="thumb-product">
                  <a href="#" id="product-links">
                    <img src="/View/Pages/delivery/img/1.jpg" alt="Áo sơ mi tencel dáng oversize" class="lazy">
