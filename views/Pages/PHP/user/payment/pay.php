                ...
                <div class="cart-summary">
                    ...
                    <div class="cart-summary__overview">
                      ...
                      if (isset($_SESSION['cart'])) { ?>
                        <div class="cart-summary__overview__item">
                          <p>Tổng tiền hàng</p>
                          <p><?php echo number_format($_SESSION['sum_price'], 0, '.', ','); ?>đ</p>
                        </div>
                        <div class="cart-summary__overview__item">
                          <p>Tạm tính</p>
                          <p><?php echo number_format($_SESSION['sum_price'], 0, '.', ','); ?>đ</p>
                        ...
                        <div class="cart-summary__overview__item">
                          <p>Phí vận chuyển</p>
                          <p><?php echo number_format(20000, 0, '.', ','); ?>đ</p>
                        </div>
                        <div class="cart-summary__overview__item">
                          <p>Tiền thanh toán</p>
                          <p><b><?php echo isset($_SESSION['sum_price']) ? ( isset($_SESSION['voucher']) ? number_format($_SESSION['sum_price'] -$_SESSION['sum_price']*$_SESSION['voucher']['discount']/100 + 20000 , 0, '.', ',') :number_format($_SESSION['sum_price'] + 20000, 0, '.', ',') ) : number_format(20000, 0, '.', ',') ?>đ</b></p>
                        </div>
                    </div>
                  </div>
                  <div class="cart-summary__voucher-form">
                    ...
                    <div class="form-group">
                      <input class="form-control" type="text" placeholder="Mã giảm giá" name="coupon_code_text" id="coupon_code_text" value= "<?php echo isset($_SESSION['voucher']) ? $_SESSION['voucher']['code'] : ""  ?>">
                      <button onclick="addVoucher()" class="btn btn--large btn--outline" id="but_coupon_code" style="background-color: white;border: 1px solid #221f20;color: #221f20;">Áp dụng</button>
                    </div>
                  </div>
                </div>
                <div class="cart-summary__button">
               
                    <button onclick= "addOrder()"  id="but-checkout-continue-step2" name="btn_continue_step2" class="btn btn--large" style="padding: 12px 24px;border-radius: 16px 0px;font-size: 16px; line-height: 24px;background-color: #221f20;color: #f7f8f9;border: 1px solid transparent;">THANH TOÁN </button>
